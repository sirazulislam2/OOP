...
/* invoices/index.twig */
class __TwigTemplate_78b9bf988dd1a33be2b87cebe4a6955c extends Template
{
    private $source;
    private $macros = [];
...
<html lang=\"en\">
    ...
    <table class=\"table\">
      ...
      <tbody class=\"text-center\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["invoice"]) {
            ...
            <td>";
            // line 41
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["invoice"], "amount", [], "any", false, false, false, 41), "html", null, true);
            echo "</td>
            <td>";
            // line 42
      ...
      <!-- <tbody class=\"text-center\">
        ...
        <?php foreach (\$invoices as \$invoice): ?>
          <tr>
            ...
            <td class=\"red\" id=\"<?= InvoiceStatus::tryFrom(\$invoice['status'])->color()->getClass() ?>\">
  ...
  <script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js\" integrity=\"sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL\" crossorigin=\"anonymous\"></script>
    ...
    {
        return array (  114 => 51,  105 => 47,  96 => 43,  92 => 42,  88 => 41,  84 => 40,  81 => 39,  76 => 38,  37 => 1,);
    }
